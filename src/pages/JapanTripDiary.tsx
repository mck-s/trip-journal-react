...
const tripEntries: TripEntry[] = [
  ...
  },
  {
    ...
    img: "/images/47.gif",
    description:
      "We took it easy today, exploring the area and getting to know the local treasures. We found the best chicken nuggets and fries… at a sushi restaurant (go figure!) and discovered that Japanese stamps kind of look like cigars!",
  },
  {
    date: "4/8",
  ...
  return (
    <div className="diary-layout">
      ...
      <div style={topBarStyles.wrap}>
        <div style={topBarStyles.title}>Our Japan Trip</div>
        <Link to="/maps" style={topBarStyles.button}>
          View Map List
        </Link>
      </div>
